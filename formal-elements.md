...
בתמונה רואים שורה של שחקנים שמשחקים עם מכשול השמן שיקשה על השחקנים זה תמונה מאד בסיסים וכללית .

![image](https://github.com/user-attachments/assets/f94f26e9-27dc-43d3-9006-17a4299facef)
...
לא מצאנו דג מלוח ב appStore או ב googlePlay  מאנו באתר אינטרנט משחק דג מלוח אבל לא נטען לנו במחשב ולא הצלנו לשחק.


המשחק המצורף לפי התיאור משחק דג מלוח רגיל שצריך להגיע לקיר מבלי שיראו אותך .
...
הרכיב שידגיש את הייחוד של המשחק שלנו זה המשאבים שהוספנו שהוספנו מכשולים לדג מלוח .
